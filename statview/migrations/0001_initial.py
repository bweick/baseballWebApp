# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-01-06 16:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Parkfactors',
            fields=[
                ('team', models.TextField(blank=True, default='MLB', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playersplit', models.TextField(blank=True, default=models.TextField(blank=True, null=True), primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Players',
            fields=[
                ('player_id', models.IntegerField(blank=True, default=1, primary_key=True, serialize=False)),
                ('player_name', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player_id', models.IntegerField(blank=True, null=True)),
                ('home_id', models.TextField(blank=True, null=True)),
                ('playeryear', models.TextField(blank=True, default=models.TextField(blank=True, null=True), primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_id', models.TextField(blank=True, default=models.IntegerField(blank=True, null=True), primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'teams',
            },
